...
function cards() {
    class MenuCard {
        constructor(src, alt, title, descr, price, parentClass , ...classes) {
            this.src = src;
            this.alt = alt;
            this.title = title;
            this.descr = descr;
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__.default)('.tabcontainer' , '.tabcontent' , '.tabheader__item' , 'tabheader__item_active');
